...
{
    public partial class uc_TAIYO : UserControl
    {
        ...
        public void ResetData()
        {
            ...
            txt_Truong92_1.BackColor = Color.White;
            txt_Truong92_2.BackColor = Color.White;
            ...
            txt_Truong92_1.ForeColor = Color.Black;
            txt_Truong92_2.ForeColor = Color.Black;
        ...
        public bool IsEmpty()
        {
            if (string.IsNullOrEmpty(txt_Truong02.Text) &&
                ...
                string.IsNullOrEmpty(txt_Truong92_1.Text) &&
                string.IsNullOrEmpty(txt_Truong92_2.Text) &&
        ...
        public bool CheckQC()
        {
            if (txt_Truong02.Text.IndexOf('?') >= 0 || txt_Truong02.Text.IndexOf('●') >= 0  ||
                ...
                txt_Truong92_1.Text.IndexOf('?') >= 0 || txt_Truong92_1.Text.IndexOf('●') >= 0 ||
                txt_Truong92_2.Text.IndexOf('?') >= 0 || txt_Truong92_2.Text.IndexOf('●') >= 0 ||
        ...
        {
            if (tb.Text.IndexOf('?') >= 0)
                tb.Text = "?"; if (tb.Text.Length > 4 && tb.Text != "" && tb.Text != "?" && tb.Text.IndexOf('●') < 0)
            {
                tb.BackColor = Color.Red;
                tb.ForeColor = Color.White;
            }
        ...
        private void txt_Truong85_EditValueChanged(object sender, EventArgs e)
        {
            if (txt_Truong85.Text.IndexOf('?') >= 0)
                txt_Truong85.Text = "?";
            if (!string.IsNullOrEmpty(txt_Truong85.Text))
            {
                if (string.IsNullOrEmpty(_category.Find(x => x == txt_Truong85.Text)))
                {
                    txt_Truong85.BackColor = Color.Red;
                    txt_Truong85.ForeColor = Color.White;
                }
                else
                {
                    txt_Truong85.BackColor = Color.White;
        ...
        private void uc_ASAHI_Load(object sender, EventArgs e)
        {
            ...
            txt_Truong92_1.GotFocus += Txt_Truong02_GotFocus;
            txt_Truong92_2.GotFocus += Txt_Truong02_GotFocus;
        ...
        public void SaveData_TAIYO(string idImage)
        {
            
            Global.db.Insert_TAIYO_New_ABC(idImage, Global.StrBatch, Global.StrUsername,
                                             txt_Truong02.Text, txt_Truong03_1.Text,txt_Truong03_2.Text,
                                             txt_Truong05.Text, txt_Truong06.Text, txt_Truong07.Text,
                                             txt_Truong13.Text, txt_Truong14.Text, txt_Truong15.Text,
                                             txt_Truong21.Text, txt_Truong22.Text, txt_Truong23.Text,
                                             txt_Truong29.Text, txt_Truong30.Text, txt_Truong31.Text,
                                             txt_Truong37.Text, txt_Truong38.Text, txt_Truong39.Text,
                                             txt_Truong45.Text, txt_Truong46.Text, txt_Truong47.Text,
                                             txt_Truong53.Text, txt_Truong54.Text, txt_Truong55.Text,
                                             txt_Truong61.Text, txt_Truong62.Text, txt_Truong63.Text,
                                             txt_Truong69.Text, txt_Truong70.Text, txt_Truong71.Text,
                                             txt_Truong77.Text, txt_Truong78.Text, txt_Truong79.Text,
                                             txt_Truong85.Text, txt_Truong0.Text, txt_Truong86.Text,
                                             txt_Truong92_1.Text, txt_Truong92_2.Text, CheckQC(), CheckABC());
        }
        ...
        private void txt_Truong92_1_EditValueChanged(object sender, EventArgs e)
        {
            if (txt_Truong92_1.Text.IndexOf('?') >= 0)
                txt_Truong92_1.Text = "?";
            if (txt_Truong92_1.Text != "" && txt_Truong92_1.Text != "?" && txt_Truong92_1.Text.IndexOf('●') < 0)
            {
                if (txt_Truong92_1.Text.Length != 6)
                {
                    txt_Truong92_1.BackColor = Color.Red;
                    txt_Truong92_1.ForeColor = Color.White;
                }
                else
                {
                    txt_Truong92_1.BackColor = Color.White;
        ...
        private void txt_Truong92_2_EditValueChanged(object sender, EventArgs e)
        {
            if (txt_Truong92_2.Text.IndexOf('?') >= 0)
                txt_Truong92_2.Text = "?";
            if (txt_Truong92_2.Text != "" && txt_Truong92_2.Text != "?" && txt_Truong92_2.Text != "●" && txt_Truong92_2.Text.IndexOf('●') < 0)
            {
                if (txt_Truong92_2.Text.Length != 6)
                {
                    txt_Truong92_2.BackColor = Color.Red;
                    txt_Truong92_2.ForeColor = Color.White;
                }
                else
                {
                    txt_Truong92_2.BackColor = Color.White;
